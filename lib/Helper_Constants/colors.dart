...
extension colors on ColorScheme {
  ...
  static const Color borderColorLight = Color(0XFFfed97f);
  static const Color borderColorDark = Color(0XFFffcd64);
  static const Color darkPinkColor = Color(0XFFdf0024);
  static const Color redColor = Color(0XFFD32F2F);
  static const Color blackColor = Color(0XFF000000);
  static const Color goldCoinColor = Color(0XFFE1B530);
